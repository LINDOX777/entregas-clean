...
class AdminCouriersScreen extends StatefulWidget {
  const AdminCouriersScreen({super.key});

  @override
  State<AdminCouriersScreen> createState() => _AdminCouriersScreenState();
}

class _AdminCouriersScreenState extends State<AdminCouriersScreen> {
  bool _loading = true;
  ...
  Future<void> _editCompaniesDialog(
    int courierId,
    ...
    try {
      ...
      ScaffoldMessenger.of(
        context,
      ).showSnackBar(const SnackBar(content: Text("Empresas atualizadas!")));
      await _load();
    } catch (e) {
      if (!mounted) return;
      ScaffoldMessenger.of(
                            ...
                            trailing: Row(
                              ...
                              children: [
                                IconButton(
                                  ...
                                  onPressed: () =>
                                      _editCompaniesDialog(id, companies),
